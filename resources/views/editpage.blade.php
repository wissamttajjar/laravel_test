    ...
    <form action="{{route('UniversityUserAdd.update',$edit_user['duser_id'])}}" method="post">
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" id="user_name" name="user_name" value="{{$edit_user->user_name}}" />
            </li>
            @error('user_name')
            <p style="color:red;">{{$message}}</p>
            @enderror
            <li>
                ...
                <input type="email" id="email" name="email" value="{{$edit_user->email}}" />
            </li>
            @error('email')
            <p style="color:red;">{{$message}}</p>
            @enderror
            <li>
                ...
                <input type="password" id="password" name="password" value="{{$edit_user->password}}" />
            </li>
            @error('password')
            <p style="color:red;">{{$message}}</p>
            @enderror
            <li>
                ...
                <input type="text" id="phone_number" name="phone_number" value="{{$edit_user->phone_number}}" />
            </li>
            @error('phone_number')
            <p style="color:red;">{{$message}}</p>
            @enderror
