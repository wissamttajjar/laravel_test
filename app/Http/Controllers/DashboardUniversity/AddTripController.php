...
class AddTripController extends Controller
{
    ...
    {
        $trip = trip::get();
        return view('all_trip')->with('trip', $trip);
    }
    ...
    public function store(Request $request)
    {
        ...
        //create Trip record
        trip::create($request->only(["trip_number", "trip_type", "start_point", "end_point", "trip_day", "start_time", "semester_id"]));
    ...
    public function edit(string $id)
    {
        ...
        try {
            ...
            return view('edittrip')->with('edittrip', trip::fingOrFail($id));
